...
def generar_diseno(data_input, color_version="AMARILLO"):
    ...
    if formato == "FLYER":
        ...
        if formato == "DISPLAY":
            ...
            pi = pi.resize((845, 845), Image.Resampling.LANCZOS); img.paste(pi, (140, 690), pi); cx_textos, anchor_y_textos = 150, 1542  # AJUSTE: baja imagen y descripción (antes 630 / 1482)
            ...
            if hay_precio:
                anchor_y_precio, p_v, espacio_entre_simbolo = 1600, precio_val, 20  # AJUSTE: baja (antes 1540)
