    ...
    if formato == "FLYER":
        ...
        if "EFERTON" in tipo or es_aniv:
            if formato == "PPL":
                ...
                # AJUSTE: el SKU baja, dejaba de leerse pegado al nombre (antes ny + 5)
                draw.text((CX_NOMBRE, ny + 22), str(row['SKU']), font=ImageFont.truetype(f"{path_fonts}/Poppins-Regular.ttf", 22), fill=(255,255,255), anchor="mm")
                ...
                GAP_MARCA_NOMBRE = 48; LH_NOMBRE = 36; GAP_NOMBRE_SKU = 32; ny = ay + GAP_MARCA_NOMBRE
                ...
                if hay_precio:
                    draw_efe_preciador(draw, prec_x, 1570, "S/", precio_val, f_ps_story, f_pv_story, scale=1.1, padding_h=24)
