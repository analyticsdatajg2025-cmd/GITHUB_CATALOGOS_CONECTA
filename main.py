        ...
        if "EFERTON" in tipo or es_aniv:
            if formato == "PPL":
                ...
                if hay_precio:
                    ...
                    PREC_CX = 240 if es_aniv else 840
                    MARGEN_PREC = 45
                    ...
                    if es_aniv:
                        zona_ini = 90
                        zona_fin = 990 - draw.textlength(str(row['Marca']), font=f_marca_ppl) - PPL_MARGEN_MARCA
                    else:
                        zona_ini = 90 + draw.textlength(str(row['Marca']), font=f_marca_ppl) + PPL_MARGEN_MARCA
                ...
                if es_aniv:
                    ...
                    x_txt = 209 if hay_precio else STORY_X_SIN_PRECIO
