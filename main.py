...
def generar_diseno(data_input, color_version="AMARILLO"):
    ...
    if formato == "FLYER":
        ...
        if formato == "DISPLAY":
            ...
            pi.thumbnail((670, 650), Image.Resampling.LANCZOS); canvas_width = 1080; px_centrado = (canvas_width - pi.width) // 2; py_posicion = 220; img.paste(pi, (px_centrado, py_posicion), pi); y_base_alineacion, y_precio = 850, 865 
