...
def generar_diseno(data_input, color_version="AMARILLO"):
    ...
    if formato == "FLYER":
        ...
        if "EFERTON" in tipo:
            ...
            draw.text((x_fecha_der, rect_y_efe := 244 + h_f//2), f_txt, font=f_f_semibold, fill="#FFA002", anchor="lm")
        else:
        ...
        if formato == "PPL":
            if "EFERTON" in tipo:
                # AJUSTE: Replica del diseño de IRRESISTIBLE + preciador naranja debajo del precio S/
                ...
                # Preciador naranja debajo del precio
                draw_efe_preciador(draw, 91 + 120, py + 70, "S/", precio_val, f_ps, f_pv, scale=0.7, tracking=-3)
